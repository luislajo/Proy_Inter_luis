/**
 * @file Punto de entrada Express: middleware global, estáticos, montaje de routers y arranque (DB, jobs reservas/ocupación).
 */
...
import { startSendCheckInCodesJob } from './jobs/sendCheckInCodes.js';
